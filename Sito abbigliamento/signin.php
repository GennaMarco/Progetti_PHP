...
<body>
	...
	<div class="container-login">
		...
		<div class="container-form">
			...
			<p class="title">SCHERMATA DI SIGN-IN</p>
		
		    <form action="action3.php" method="POST">

		        <p>Username nuovo: <input name="username" type="text" placeholder="inserisci username"></p>
		        <p>Password nuova: <input name="password" type="password" placeholder="inserisci password"></p>
		        <div class="login">

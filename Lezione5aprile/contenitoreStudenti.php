...
/*$studentiDB = [
       ...
       $result = mysqli_query($mysqliConnection, $querysql);

       while($row = mysqli_fetch_array($result))
       {
	      $studentiDB[] = array("nome" => $row['nome'],"cognome" => $row['cognome'], "email" =>$row['email']);   // array di array $studentiDB
       }
	   ...
	   {
	      $elencoStudenti[] = new Studente($studente['nome'], $studente['cognome'], $studente['email']);    // array di oggetti $elencoStudenti
	   }
